...
namespace adeeb.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<ActionResult<User>> Register(RegisterNewUserForCompanyDto user)
        {
            ...
            bool emailExists = await _context.CustomUsers.AnyAsync(u => u.Email == user.Email);
            if (emailExists)
            {
            ...
            _context.CustomUsers.Add(userToAdd);
        ...
        public async Task<ActionResult<User>> Login(LoginRequest loginRequest)
        {
            ...
            var user = await _context.CustomUsers.FirstOrDefaultAsync(u => u.Email == loginRequest.Email);
            if (user == null)
            {
